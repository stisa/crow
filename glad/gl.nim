#[
    OpenGL loader generated by glad 0.1.12a0 on Mon Nov 28 00:03:04 2016.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.5" --generator="nim" --spec="gl" --no-loader --extensions=""
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=nim&specification=gl&api=gl%3D4.5
]#
...
var
  ...
  glShaderSource*: proc (shader: GLuint, count: GLsizei, cstringArray:string, length: ptr GLint) {.cdecl.}
...
proc load_GL_VERSION_2_0(load: proc) =
  ...
  glShaderSource = cast[proc (shader: GLuint, count: GLsizei, cstringArray:string, length: ptr GLint) {.cdecl.}](load("glShaderSource"))
